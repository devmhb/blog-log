...
const PopularCard = () => {
  return (
    <div className={styles.popularC}>
      <button className={styles.categories}>Travel</button>
      <h2 className={styles.popularC_title}>
      ...
      <p className={styles.popularC_desc}>
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Officiis hic
        harum distinctio, praesentium cumque tenetur optio cupiditate
        necessitatibus vitae earum.
      </p>
    </div>
  );
};
